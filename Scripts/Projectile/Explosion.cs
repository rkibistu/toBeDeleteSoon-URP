...
public class Explosion : NetworkBehaviour, IPredictedSpawnBehaviour {
    // PRIVATE MEMBERS
    ...
    public override void Spawned() {
        ...
        if (HasStateAuthority == true || Object.IsPredictedSpawn == true) {
            Explode();
        }
    ...
    private void Explode() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            Debug.Log("expl process: " + Object.InputAuthority);
            HitUtility.ProcessHit(Object.InputAuthority, direction, hit, damage, _hitType, out bool? _);
        }
