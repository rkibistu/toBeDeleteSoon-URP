...
public class UIGameplayView : UIView {
    ...
    protected override void OnInitialize() {
        ...
        if(Context.Instance.Gameplay.TeamInfo != null) {

            _uiScore = GetComponentInChildren<UIScore>(true);
    ...
    protected override void OnTick() {
        ...
        _ammo.UpdateGrenade(_observedAgent.Weapons?.CurrentWeapon?.DamageGrenadeMagazine, _observedAgent.Weapons?.CurrentWeapon?.SmokeGrenadeMagazine);
        ...
        _uiScore?.UpdateScore(_runningGameplay.TeamInfo);
