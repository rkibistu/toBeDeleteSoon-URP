...
public class Weapon : NetworkBehaviour {
    ...
    public WeaponMagazine DamageGrenadeMagazine => _damageGrenadeMagazine;
    public WeaponMagazine SmokeGrenadeMagazine => _smokeGrenadeMagazine;
    ...
    [SerializeField]
    private WeaponMagazine _damageGrenadeMagazine;
    [SerializeField]
    private WeaponMagazine _smokeGrenadeMagazine;
